...
def train():
    ...
    pred_loc, pred_confs = get_box_logits(img,config)
    print(pred_loc,config.total_anchor_num)
    train_tensors = get_tree_box_loss(conf, loc, pred_loc, pred_confs,config)
